...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = 'https://github.com/sapristi-tool/sapristi'
  ...
  spec.add_development_dependency 'guard-reek', '~> 1.2.0'
  spec.add_development_dependency 'guard-rspec', '~> 4.7.3'
  spec.add_development_dependency 'guard-rubocop', '~> 1.4.0'
  spec.add_development_dependency 'guard-rubycritic', '~> 2.9.0'
