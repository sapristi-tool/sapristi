...
module Sapristi
  RSpec.describe WindowManager do
    ...
    it 'find one window by title' do
      ...
      actual_windows = under_test.find_window(/deleteme_title.txt/)
                                 .map(&:to_h)
